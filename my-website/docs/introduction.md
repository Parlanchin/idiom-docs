...
These docs are meant for members of Parlanchín or contributors to Idiom. Before working on the project we'll need to set up your permissions and get any .env variables and other secrets to you. After that you can read the instructions (pretty straightforward at the moment!).
